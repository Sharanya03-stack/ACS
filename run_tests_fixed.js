...
async function run() {
  ...
  await client.end(); // close before long auth operations
  
  // POSTGREST RELOAD SCHEMA VIA API
  // Using an authenticated API call will often trigger cache reload or we just wait
